...
class Help(controllers.Controller):
    help = { 'none' :               [_('Error'), _('<p>We could not find that help item</p>')],
            ...
            'group_prerequisite':   [_('Must Belong To'), _('''<p>Before a user can join this group, they must belong to the group listed in this box.  Recommended values are for the '%s' group.</p>''') % config.get('cla_done_group', 'cla_done')],
